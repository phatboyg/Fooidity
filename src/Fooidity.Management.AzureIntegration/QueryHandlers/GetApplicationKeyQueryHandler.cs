namespace Fooidity.Management.AzureIntegration.QueryHandlers
{
    ...
    public class GetApplicationKeyQueryHandler :
        IQueryHandler<IGetApplicationByKey, IOrganizationApplicationKey>
    {
        readonly IAzureManagementSettings _settings;
        readonly ICloudTableProvider _tableProvider;

        public GetApplicationKeyQueryHandler(ICloudTableProvider tableProvider, IAzureManagementSettings settings)
        {
            _tableProvider = tableProvider;
            _settings = settings;
        }

        public async Task<IOrganizationApplicationKey> Execute(IGetApplicationByKey query,
